...
function PurchaseBillTemplate({ billData = {}, companyDetails = {}, partyDetails = {}, bankDetails = {}, payments = [] }) {
    ...
    <div className="p-8 bg-white rounded shadow max-w-3xl mx-auto text-sm print:p-0 print:shadow-none print:bg-white">
      ...
      <div className="flex justify-between items-center mb-4">
        ...
        <div className="text-right">
          <div className="text-2xl font-bold tracking-wider">PURCHASE BILL</div>
          <div className="mt-2"><span className="font-semibold">Bill No:</span> {billData.purchaseBillNumber || billData.number || ''}</div>
      ...
      <div className="flex flex-row justify-between mb-2">
        ...
        <div className="text-right">
          <div className="font-semibold">Bill From (Seller):</div>
...
export default PurchaseBillTemplate; 